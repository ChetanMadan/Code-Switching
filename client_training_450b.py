...
def train(model, device, train_loader, criterion, optimizer, epoch, iter_meter, writer, scheduler):
    ...
    if (epoch+1)%2 == 0:
        model.eval().cpu()
        ckpt_model_filename = "ckpt_epoch_" + str(epoch+1) + "_batch_id_" + str(batch_idx+1) + "_450b.pth"
...
print(epoch_num)
writer = SummaryWriter('train_logs_450_b/')
...
model.eval().cpu()
save_model_filename = "final_epoch_client2" + str(epoch + 1)  + ".model"
